...
@SpringBootTest(classes = DevoxxUkQuestion2Application.class, webEnvironment = WebEnvironment.RANDOM_PORT)
@TestPropertySource(properties = "game.eventing.enabled=true")
@Testcontainers
public class DevoxxUkQuestion2ApplicationTests {
    ...
    void whenAnswersSubmittedThenGameScoreReturned() throws InterruptedException {
        ...
        webTestClient
                ...
                .expectBody(GameScore.class).value(gameScore -> {
                    ...
                    assertThat(gameScore.level()).isEqualTo("devoxxuk-question-2");
